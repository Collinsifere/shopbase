...
class NamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post names_url, params: { name: { description: @name.description, image: @name.image, price: @name.price, size: @name.size } }
    end
  ...
  test "should update name" do
    patch name_url(@name), params: { name: { description: @name.description, image: @name.image, price: @name.price, size: @name.size } }
